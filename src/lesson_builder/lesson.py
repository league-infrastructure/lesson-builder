    ...
    def assignments(self):
        for a in self.ld['assignments']:
            ...
            if not abs_dir.exists():
                raise FileNotFoundError(f'Assignment {a} not found in assignment dir {self.lesson_plan.asgn_dir}' )
...
class LessonPlan:
    ...
    def __init__(self, less_plan_dir, vue_doc_dir, asgn_dir=None, less_subdir='lessons'):
